  ...
  return (
    <>
      <div className=" border-gray-500 max-h-[600px] border-2 p-2.5 pl-7 flex flex-col items-center justify-center gap-4">
        ...
        <button className="mb-5 px-2.5 py-1 text-white text-lg font-bold border-none cursor-pointer hover:shadow-md hover:shadow-black/50" style={{ backgroundColor: btnColor }}>
          Add to cart
        </button>
      </div>
    </>
